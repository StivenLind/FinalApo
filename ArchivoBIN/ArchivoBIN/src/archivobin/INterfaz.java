...
public class INterfaz extends javax.swing.JFrame {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try{
            ObjectOutputStream guar = new ObjectOutputStream(new FileOutputStream(c));
            guar.writeObject(c);
            guar.writeObject(n);
            guar.writeObject(a);
        }catch(Exception e){
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       String c = txtcedula.getText();
       try{
           ObjectInputStream tra = new ObjectInputStream(new FileInputStream(c));
           Object ce = tra.readObject();
           Object no = tra.readObject();
           Object ap = tra.readObject();
           txtcedula.setText(ce.toString());

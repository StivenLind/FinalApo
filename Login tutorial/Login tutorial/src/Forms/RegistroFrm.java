...
public class RegistroFrm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel2.setBackground(new java.awt.Color(69, 42, 0));
        ...
        pnlRegistrar1.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                pnlRegistrar1MouseClicked(evt);
            }
        });
        ...
        lblInicioSesion1.setFont(new java.awt.Font("Tahoma", 1, 16)); // NOI18N
        lblInicioSesion1.setForeground(new java.awt.Color(255, 255, 255));
        lblInicioSesion1.setText("Menu");
        lblInicioSesion1.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                lblInicioSesion1MouseClicked(evt);
            }
        });
    ...
    private void pnlRegistrar1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_pnlRegistrar1MouseClicked

        this.dispose();
        MenuFrm mMenuFrm = new MenuFrm();
        mMenuFrm.setVisible(true);
    }//GEN-LAST:event_pnlRegistrar1MouseClicked

    private void lblInicioSesion1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblInicioSesion1MouseClicked
        // TODO add your handling code here:
    }//GEN-LAST:event_lblInicioSesion1MouseClicked
